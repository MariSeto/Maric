...
import net.mariseto.maric.item.custom.ModFoods;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> BLOOCUP = ITEMS.register("bloocup", () -> new Item(new Item.Properties().food(ModFoods.BLOOCUP)));
